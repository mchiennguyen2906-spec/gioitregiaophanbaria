...
// Hard-code public Supabase credentials to ensure Vercel builds always have correct values
// These are safe to expose (anon key = public key with RLS protection)
